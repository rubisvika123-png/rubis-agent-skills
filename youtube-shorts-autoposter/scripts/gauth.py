"""Google auth for the YouTube autoposter — ONE token.json covers both Drive
(download source videos) and YouTube (upload). Reads OAuth client from config.env
next to the skill. token.json is created once by oauth_youtube.py."""
import os
